...
public class SignUp_Model {
    ...
    public SignUp_Model(int id, String name, String email, String phone, Object dob, Object gender, Object country_code, Object country, Object city, Object address, String avatar, String is_social, String role, Object email_verified_at, Object timePeriod, Date created_at, Date updated_at) {
        this.id = id;
        this.name = name;
        this.email = email;
        this.phone = phone;
