...
public class Accept_Request_Model {
    public int id;
    ...
    public Accept_Request_Model() {
    }

    public Accept_Request_Model(int id, String user_id, String angel_id, String angel_name, String angel_email, String angel_relation, int status, Date created_at, Date updated_at) {
        this.id = id;
