...
public class My_Evidence_fragment extends Fragment {
...
//    ViewPager viewPager2;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        myEvedenceAdapter = new MyEvedenceAdapter(myEvidenceArrayList, new EvdClickListener() {
            ...
            public void onPlayClick(MyEvidence evidence) {
                EvdPlayAndMapFragment evdPlayAndMapFragment = new EvdPlayAndMapFragment(evidence);
                FragmentManager fragmentManager = getActivity().getSupportFragmentManager();
                FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction();
                fragmentTransaction.replace(R.id.frame1, evdPlayAndMapFragment);
    ...
    private void loadDataFromServer() {
        ...
        SharedPreferences preferences = getActivity().getSharedPreferences("credentials", Context.MODE_PRIVATE);
        String userID = preferences.getString("userId", " ");
        Call<MyEvidenceResponse> call = RetrofitClientInstance.getInstance().getApi().myEvidence(userID);
